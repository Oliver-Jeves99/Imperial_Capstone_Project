...
settings = {
    ...
    "f2": dict(acq="ei", xi=0.03, frac_local=0.80, top_k=6, local_sigma=0.10,
               max_step=0.20, min_dist_threshold=0.07,
               boundary_penalty_weight=0.10, boundary_eps=0.03),

    "f3": dict(acq="ucb", beta=3.5, frac_local=0.85, top_k=7, local_sigma=0.14,
               interior_eps=0.02, boundary_penalty_weight=0.25, boundary_eps=0.05,
               min_dist_threshold=0.05),

    "f4": dict(acq="ei", xi=0.03, frac_local=0.90, top_k=7, local_sigma=0.06,
    ...
    "f6": dict(acq="ucb", beta=4.0, frac_local=0.60, top_k=6, local_sigma=0.14,
               interior_eps=0.01,
               boundary_penalty_weight=0.18, boundary_eps=0.04,
               min_dist_threshold=0.06),

    "f7": dict(acq="ei", xi=0.03, frac_local=0.80, top_k=8, local_sigma=0.10,
               interior_eps=0.01,
               max_step=0.22, min_dist_threshold=0.06,
               boundary_penalty_weight=0.12, boundary_eps=0.03),

    "f8": dict(acq="ei", xi=0.03, frac_local=0.80, top_k=8, local_sigma=0.10,
...
x5 = propose_next_point_hybrid(f5_inputs, f5_outputs, n_candidates=200_000, **settings["f5"])
...
print("\n--- Week 8 proposed queries (submit these) ---")
