...
settings = {
    "f1": dict(
        acq="ucb", beta=14.0,
        frac_local=0.10, top_k=3, local_sigma=0.25,
    ...
    "f2": dict(
        acq="ei", xi=0.015,
        frac_local=0.75, top_k=6, local_sigma=0.07,
        max_step=0.18, min_dist_threshold=0.06,
        boundary_penalty_weight=0.05, boundary_eps=0.03,
    ),

    "f3": dict(
        acq="ei", xi=0.02,
        frac_local=0.80, top_k=7, local_sigma=0.10,
    ...
    "f4": dict(
        acq="ei", xi=0.02,
        frac_local=0.92, top_k=10, local_sigma=0.045,
    ...
    "f5": dict(
        acq="ei", xi=0.01,
        frac_local=1.00, top_k=1, local_sigma=0.025,
        max_step=0.05, min_dist_threshold=0.10,
        interpret=True, interpret_repeats=10,
    ...
    "f6": dict(
        acq="ei", xi=0.02,
        frac_local=0.80, top_k=8, local_sigma=0.09,
        max_step=0.18, min_dist_threshold=0.08,
        interior_eps=0.01,
    ...
    "f7": dict(
        acq="ei", xi=0.02,
        frac_local=0.85, top_k=9, local_sigma=0.08,
        max_step=0.16, min_dist_threshold=0.06,
        interior_eps=0.01,
        boundary_penalty_weight=0.05, boundary_eps=0.03,
    ),
    ...
    "f8": dict(
        acq="ei", xi=0.01,
        frac_local=1.00, top_k=10, local_sigma=0.05,
        max_step=0.12, min_dist_threshold=0.10,
        interior_eps=0.00,
        boundary_penalty_weight=0.00, boundary_eps=0.03,
    ),
}
...
print("\n--- Week 10 proposed queries (submit these) ---")
